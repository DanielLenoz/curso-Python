class Vehicle:
    ...
    #estas dos metodos lanzaran un error cuando no son utilizado en las subclases
    #cuando se llamen estos metodos en las subclases y se cambie su contendio por otro se llamara polimorfismo
...
#Herencia
class Car(Vehicle): #Cundo utilizar herencia no tienes que volver a repertir el metodo __init__ con sus propiedades devido a que ya esta en la clase padre y estos son heredados a la clase hija

    #Polimorfismo: estamos sobreescribiendo el metodo start_engine de la clase padre esto se llama polimorfismo
    def start_engine(self):
...
#cuando estamos creando los objetos de cada clase podemos ver que aunque las clases hijas no tienen el metodo __init__ este es heredado de la clase padre
